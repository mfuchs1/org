...
[fn:1] =Text= steht für Dateien wie z.B. =init.el= oder =denote.el=, etc.

[fn:2] ~Text~ steht für Funktionen, Befehle, Variablen, etc, wie ~org-capture-templates~, ~org-directory~, ~M-x denote~ (create a new note), etc.
